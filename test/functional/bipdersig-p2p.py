...
class BIP66Test(UscoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # uscoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and uscoind produces more specific reject
            # reasons.
