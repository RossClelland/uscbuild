...
from test_framework.test_framework import UscoinTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (UscoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that uscoin has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("uscoind has not been built with zmq enabled.")
