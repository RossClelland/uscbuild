...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the UscoinTestFramework
    pass

class ExampleTest(UscoinTestFramework):
    # Each functional test is a subclass of the UscoinTestFramework class.
    ...
    def custom_method(self):
        ...
        UscoinTestFramework class so other tests can use it."""
