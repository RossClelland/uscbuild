...
unlocked to sign the Uscoin-Qt.app bundle.
...
allowing somebody to distribute a Uscoin-Qt.app or uscoin-qt-setup.exe with a valid
...
that the uscoin-qt.exe file inside the installer had not been tampered with.
