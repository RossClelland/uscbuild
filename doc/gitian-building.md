...
- [LXC](https://linuxcontainers.org/), see also [Gitian host docker container](https://github.com/gdm85/tenku/tree/master/docker/gitian-uscoin-host/README.md).
...
Output from `gbuild` will look something like
    ...
    From https://github.com/uscoin/uscoin
...
For example:
```bash
URL=https://github.com/laanwj/uscoin.git
...
UCSPATH=/some/root/path/uscoin
SIGPATH=/some/root/path/uscoin-detached-sigs

./bin/gbuild --url uscoin=${UCSPATH},signature=${SIGPATH} ../uscoin/contrib/gitian-descriptors/gitian-win-signer.yml
```
...
[uscoin-core/gitian.sigs](https://github.com/uscoin-core/gitian.sigs/) repository, or if that's not possible create a pull
