...
This document provides guidelines for internationalization of the Uscoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `uscoin_en.ts` remains unchanged.
