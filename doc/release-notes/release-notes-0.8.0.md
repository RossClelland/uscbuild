Uscoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/uscoin/files/Uscoin/uscoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Uscoin
...
New/changed settings (command-line or uscoin.conf file)
--------------------------------------------------------
