Uscoin Core version 0.10.4 is now available from:

  <https://uscoin.org/bin/uscoin-core-0.10.4/>
...
- #6953 `43c2789` Split uscoin-tx into its own package
- #6953 `dfe0d4d` Include uscoin-tx binary on Debian/Ubuntu
