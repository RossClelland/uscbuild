Uscoin Core version 0.13.2 is now available from:

  <https://uscoin.org/bin/uscoin-core-0.13.2/>
...
- #8908 `4a974b2` Update uscoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow uscoin-tx to create v2 transactions (btcdrak)
