Uscoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/uscoin/files/Uscoin/uscoin-0.5.4/
...
http://gitorious.org/uscoin/uscoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Uscoin-Qt notifications under Growl 1.3.
Increase required age of Uscoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxUscoin properly when installing Uscoin-Qt over it. (Windows)
