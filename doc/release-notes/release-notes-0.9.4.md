Uscoin Core version 0.9.4 is now available from:

  https://uscoin.org/bin/0.9.4/
...
this update is incompatible with the Uscoin system and could lead to consensus
forks.

Uscoin Core released binaries from https://uscoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~uscoin/+archive/ubuntu/uscoin
- A third-party or self-compiled Uscoin Core

upgrade to Uscoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
