Uscoin version 0.7.2 is now available from:
  http://sourceforge.net/projects/uscoin/files/Uscoin/uscoin-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Uscoin-Qt to crash on Windows when exiting.
