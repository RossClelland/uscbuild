Download URL: https://sourceforge.net/projects/uscoin/files/Uscoin/uscoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 UCS fee schedule (users still pay 0.01 UCS per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #uscoin00 - #uscoin99
