Uscoin Core version 0.9.2.1 is now available from:

  https://uscoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 UCS to 0.01 UCS
...
- Fix "Start uscoin on system login"
