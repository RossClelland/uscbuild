...
#ifndef USCOIN_TEST_SCRIPTNUM10_H
#define USCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Uscoin Core 0.10.0, for cross-comparison.
 */
public:
