 ...
 * between uscoind, and uscoin-qt and non-server tools.
*/
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), USCOIN_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/uscoin/uscoin>";
    const std::string URL_WEBSITE = "<https://uscoincore.org>";
...
/** Sanity checks
 *  Ensure that Uscoin is running in a usable environment with all
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", USCOIN_CONF_FILENAME)).string());
