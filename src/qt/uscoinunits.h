...
#ifndef USCOIN_QT_USCOINUNITS_H
#define USCOIN_QT_USCOINUNITS_H
...
/** Uscoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class UscoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit UscoinUnits(QObject *parent);

    /** Uscoin units.
      @note Source: https://en.uscoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        UCS,
...
typedef UscoinUnits::Unit UscoinUnit;

#endif // USCOIN_QT_USCOINUNITS_H
